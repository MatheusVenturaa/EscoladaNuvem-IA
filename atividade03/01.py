...
pi = 3.14159265 #Não seria necessário declarar uma váriavel para PI, poderia inserir apenas o valor na hora do calculo 

print("CALCULADORA DA ÁREA DE UMA CIRCUNFERÊNCIA")
